...
生成一张 {画幅} 的品牌角色海报。以大面积纯白留白为底，顶部放置一个由粗重、圆润、略有挤压和轻微倾斜的黑色无衬线字组成的主标题「{主标题}」；让部分字母或字形像软体玩具一样鼓起、变形，并可嵌入极简眼睛、触角或小表情。画面中心放置一个原创、笨拙可爱的单色或低饱和角色，使用极细黑色描边和大块浅蓝、珊瑚红、浅灰填色；配合少量圆角黑底白字标签、橙红色几何贴纸和一段可读的品牌说明。排版可以上下倒置、旋转或沿弧线排列，但必须保持层级清晰和充足呼吸感。整体像独立餐饮或生活方式品牌的角色宣传页，平面印刷质感，轻松、俏皮、现代。只使用我提供的文字：{文案}；不要生成品牌水印、社交账号、二维码、无关商品或模仿参考图中的具体角色。
...
生成一张 {画幅} 的城市观察海报。上半部分使用大面积柔和荧光柠檬黄底，中心放一个由规则圆点组成的低分辨率抽象图标或短词「{主标题}」，点阵颜色只用黑、墨绿、暗橙和米白。下半部分嵌入一张真实感城市建筑或街道照片，照片上叠加 3—6 个纯荧光黄色的人物剪影，剪影边缘干净、姿态各不相同，像被高亮标记的城市行人。照片与黄底之间用一条横向深灰信息带分隔，放入少量对齐整齐的短文案「{文案}」。配色克制，摄影与平面图形有明显断层，带有独立设计工作室的城市档案感。不要添加虚构的长段落、品牌标志、二维码、复杂装饰或多余颜色。
...
生成一张 {画幅} 的透明塑料证件套产品摄影与身份档案卡。画面正面俯拍一个透明硬质卡套，顶部有金属挂环；内部是一张温暖象牙白卡片。卡片采用黑色粗体无衬线标题「{主标题}」，下方有细虚线分隔、简短副标题「{副标题}」、一张居中的 {主体} 肖像或工作照片，以及姓名、职位、角色、工具等字段。字段标签使用整齐印刷体，字段内容使用自然不规整的黑色手写体，像真实填写的档案。保留条形码、编号、标签贴纸等少量信息设计元素，纸张轻微颗粒，透明塑料有真实反光和边缘折射。整体像独立设计师的工作证、展览证或职业身份卡。只生成我提供的字段和文字：{字段内容}；不要杜撰姓名、公司、二维码或额外说明。
...
生成一张 {画幅} 的青春主题编辑海报。使用纯白背景和大面积留白，把 8—12 个与「{主题}」有关的真实物件抠图按环形或松散圆周排列：{物件清单}。物件保持自然摄影质感、轻微旧胶片色偏和干净边缘，颜色明快但彼此错开。画面中心只放一个细黑色圆心、指针、斜线或简短信息点，形成“物件围绕某个时刻/主题聚集”的结构。顶部使用绿色描边的复古衬线或打字机风标题「{主标题}」，周围加入少量绿色、粉色、黄色、蓝色圆点作为节奏标记；底部可用一条饱和绿色横条放置来源或日期。整体有音乐企划、青年文化档案和唱片视觉的感觉。不要加入无关的人物、虚构品牌或密集正文，不要让物件互相遮挡到难以识别。
...
生成一张 {画幅} 的复古照片拼贴。底层是一张带暖棕色调、低对比度和轻微纸张褪色的旧家庭合影或街头纪实照片，保留原始照片的颗粒、人物姿态和历史感。其上覆盖一组原创荧光涂鸦角色与贴纸：使用饱和钴蓝、酸绿、亮红、紫色和黄色的大色块，粗黑或深色线条，圆眼睛、夸张嘴巴、虫状肢体、波浪形装饰和简单表情；让涂鸦角色与照片中的人物、动物或道具发生遮挡、拥抱、牵手或对视关系。照片与平面涂鸦要形成故意的时代错位，气质荒诞、亲切、带一点地下杂志感。只使用我提供的短句「{文案}」；不要复制参考图中的人物、艺术家签名、品牌或具体角色，不要加入水印。
...
生成一张 {画幅} 的生活方式分镜海报。使用温暖的浅灰米白纸张背景，按 3×3 排列九个带透视折角的室内小房间画框，每个画框像从墙面切开的空间窗口，框线用细黑色手绘线，边缘保持略微不规则。每格呈现一个具体日常片段：{九个片段}。人物和家具用简洁扁平插画表现，人物脸部只保留少量线条；全画面只以橙色作为重点色，少量使用棕色木质色、黑色和白色，保持统一的室内生活气息。每格左上角放小号编号，底部配一份与九格对应的中文说明清单，标题为「{主标题}」。构图要像一本生活观察手册或公寓居住故事板，安静、清楚、可阅读。不要出现照片质感、渐变 3D、复杂背景、虚构品牌和额外段落。
